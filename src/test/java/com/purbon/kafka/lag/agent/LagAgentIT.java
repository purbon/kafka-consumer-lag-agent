...
public class LagAgentIT {
  ...
  public void agentLoads() throws IOException, InterruptedException {
    ...
    System.out.println(javaagent+" -cp "+buildClasspath()+" com.purbon.kafka.lag.agent.TestApp");

    final Process app = new ProcessBuilder()
        .command(java, javaagent, "-cp", buildClasspath(), "com.purbon.kafka.lag.agent.TestApp")
        .start();
    try {
